...
export function constructMaze(matrix, config) {
    ...
    function randomlyBreakWalls(percentage) {
        ...
        while (wallsBroken < wallsToBreak && attempts < maxAttempts) {
            ...
            if (y > 1 && matrix.cells[y][x].walls[Direction.Up])
                possibleDirections.push(Direction.Up);
            if (x < width - 2 && matrix.cells[y][x].walls[Direction.Right])
                possibleDirections.push(Direction.Right);
            if (y < height - 2 && matrix.cells[y][x].walls[Direction.Down])
                possibleDirections.push(Direction.Down);
            if (x > 1 && matrix.cells[y][x].walls[Direction.Left])
